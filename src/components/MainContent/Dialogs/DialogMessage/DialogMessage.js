...
function DialogMessage({id, message, likesCount}){
    ...
    return(
            ...
            <div key={id} className={classes.message}>
                ...
                <div className={classes.answer}>
                    ...
                    <div className={`${classes.round} ${classes.roundSecond}`}>you</div>
                </div>
            </div>
...
// const renderMyMessage = myMessagesData.map((elem) => {
//     return <MyMessage
//         key={elem.id}
...
//     />
// });
// const renderAnswer = answerData.map((elem) => {
//     return <Answer
//         key={elem.id}
//         message={elem.message}
//         likesCount={elem.likesCount}
